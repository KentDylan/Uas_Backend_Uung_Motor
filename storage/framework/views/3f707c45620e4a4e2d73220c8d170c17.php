            ...
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary">Go to Brand Management</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 mb-4">
            ...
            <div class="col-md-6 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary">Go to Appointment
                            Management</a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.nofooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\UNTAR\Semester 4\Back-End\UAS\mantuls\Uung_Motor_Final - Kent\resources\views/admin-page/dashboard.blade.php ENDPATH**/ ?>