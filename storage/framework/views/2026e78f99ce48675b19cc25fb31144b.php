            ...
            <div class="spotLight__row">
                    ...
                    <a href="" class="cardWrapper">
                        <picture class="spotLightImageWrapper">
                            ...
                            <img width="1040" height="490" class="spotLightImage"
                                src="<?php echo e(asset('img/yamaha/xmax.png')); ?>" alt="Raider GE78 HX 13V" loading="lazy" />
                        </picture>
                ...
                <div class="spotLight__col">
                    ...
                    <a href="" class="cardWrapper">
                        ...
                        <div class="card__body center">
                            <h3 class="title">MEG 342C QD-OLED</h3>
                ...
                <div class="spotLight__col">
                    ...
                    <a href="" class="cardWrapper">
                        ...
                        <div class="card__body center">
                            <h3 class="title">GeForce RTX 4090 SUPRIM X 24G</h3>
                            <p class="context">Change The Game</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="spotLight__col">
                    ...
                    <a href="" class="cardWrapper">
                        <picture class="spotLightImageWrapper">
                            ...
                            <img width="1040" height="490" class="spotLightImage"
                                src="<?php echo e(asset('img/yamaha/lexi.png')); ?>" alt="Raider GE78 HX 13V" loading="lazy" />
                        </picture>
                        <div class="card__body center">
                            <h3 class="title">Raider GE78 HX 13V</h3>
                            <p class="context">The First Choice for Professionals</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="spotLight__col">
                    ...
                    <a href="" class="cardWrapper">
                        <picture class="spotLightImageWrapper">
                            ...
                            <img width="1040" height="490" class="spotLightImage"
                                src="<?php echo e(asset('img/yamaha/freego.png')); ?>" alt="Raider GE78 HX 13V" loading="lazy" />
                        </picture>
                        <div class="card__body center">
                            <h3 class="title">MEG Z790 ACE</h3>
                            <p class="context">Lustrous Aesthetics, Pure Performance</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="spotLight__col">
                    ...
                    <a href="" class="cardWrapper">
                        <picture class="spotLightImageWrapper">
                            ...
                            <img width="1040" height="490" class="spotLightImage"
                                src="<?php echo e(asset('img/yamaha/gear125.png')); ?>" alt="Raider GE78 HX 13V" loading="lazy" />
                        </picture>
                        <div class="card__body center">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\UNTAR\Semester 4\Back-End\UAS\github\Uung_Motor\resources\views/home.blade.php ENDPATH**/ ?>