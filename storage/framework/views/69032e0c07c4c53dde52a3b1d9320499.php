<nav>
    ...
    <div class="links-container">
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('appointment')); ?>"
            class="<?php echo e(request()->routeIs('appointment') ? 'active' : ''); ?>">Appointment</a>
        <?php if(!auth()->check()): ?>
...
<?php /**PATH C:\Users\UNTAR\Semester 4\Back-End\UAS\github\Uung_Motor-FINAL - Copy\resources\views/layouts/nav.blade.php ENDPATH**/ ?>