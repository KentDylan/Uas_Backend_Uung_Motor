                    ...
                    <a href="" class="cardWrapper">
                        <picture class="spotLightImageWrapper">
                            ...
                            <img width="1040" height="490" class="spotLightImage"
                                src="<?php echo e(asset('img/yamaha/xmax.png')); ?>" alt="Yamaha XMAX" loading="lazy" />
                        </picture>
                ...
                <div class="spotLight__col">
                    ...
                    <a href="" class="cardWrapper">
                        <picture class="spotLightImageWrapper">
                            ...
                            <img width="1040" height="490" class="spotLightImage"
                                src="<?php echo e(asset('img/yamaha/lexi.png')); ?>" alt="Yamaha Lexi" loading="lazy" />
                        </picture>
                        <div class="card__body center">
                ...
                <div class="spotLight__col">
                    ...
                    <a href="" class="cardWrapper">
                        <picture class="spotLightImageWrapper">
                            ...
                            <img width="1040" height="490" class="spotLightImage"
                                src="<?php echo e(asset('img/yamaha/freego.png')); ?>" alt="Yamaha FreeGo" loading="lazy" />
                        </picture>
                        <div class="card__body center">
                ...
                <div class="spotLight__col">
                    ...
                    <a href="" class="cardWrapper">
                        <picture class="spotLightImageWrapper">
                            ...
                            <img width="1040" height="490" class="spotLightImage"
                                src="<?php echo e(asset('img/yamaha/gear125.png')); ?>" alt="Yamaha Gear 125" loading="lazy" />
                        </picture>
                        <div class="card__body center">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\UNTAR\Semester 4\Back-End\UAS\mantuls\Uung_Motor_Final - Kent\resources\views/home.blade.php ENDPATH**/ ?>